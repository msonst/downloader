...
public class DownloadStatusCode {
  ...
  /**
   * Switching Protocols (101): The server is switching protocols as a result of the client's request.
   */
  public static final DownloadStatusCode SWITCHING_PROTOCOLS = new DownloadStatusCode(101);

  /**
   * Processing (102): The server is processing the client's request, but no response is available yet.
   */
  ...
  /**
   * Non-Authoritative Information (203): The information returned is not authoritative.
   */
  public static final DownloadStatusCode NON_AUTHORITATIVE_INFORMATION = new DownloadStatusCode(203);

  /**
   * No Content (204): The server successfully processed the request but there is no content to send.
   */
  public static final DownloadStatusCode NO_CONTENT = new DownloadStatusCode(204);

  /**
   * Reset Content (205): The server successfully processed the request and reset the current content.
   */
  public static final DownloadStatusCode RESET_CONTENT = new DownloadStatusCode(205);

  /**
   * Partial Content (206): The server is delivering only part of the resource due to a range header sent by the client.
   */
  public static final DownloadStatusCode PARTIAL_CONTENT = new DownloadStatusCode(206);

  /**
   * Multi-Status (207): The message body that follows is an XML message and can contain a number of separate response codes.
   */
  ...
  /**
   * Moved Temporarily (302): The requested resource resides temporarily under a different URI.
   */
  ...
  /**
   * Not Modified (304): The resource has not been modified since the version specified in the request headers.
   */
  ...
  /**
   * Precondition Failed (412): The precondition given in the request headers fields evaluated to false by the server.
   */
  public static final DownloadStatusCode PRECONDITION_FAILED = new DownloadStatusCode(412);

  /**
   * Request Too Long (413): The server will not process the request because it is too large.
   */
  public static final DownloadStatusCode REQUEST_TOO_LONG = new DownloadStatusCode(413);

  /**
   * Request URI Too Long (414): The server will not process the request because the URI is too long.
   */
  public static final DownloadStatusCode REQUEST_URI_TOO_LONG = new DownloadStatusCode(414);

  /**
   * Unsupported Media Type (415): The server will not accept the request unless the client presents a valid media type.
   */
  ...
  /**
   * Insufficient Space on Resource (419): The server would return this response if the request method is known by the server but has been disabled and cannot be used.
   */
  ...
  /**
   * Failed Dependency (424): The request failed because it depended on another request and that request failed.
   */
  ...
  // Server Error
  /**
   * Internal Server Error (500): An unexpected condition was encountered by the server and no more specific message is suitable.
   */
  ...
  /**
   * HTTP Version Not Supported (505): The server does not support the HTTP protocol version that was used in the request.
   */
  public static final DownloadStatusCode HTTP_VERSION_NOT_SUPPORTED = new DownloadStatusCode(505);

  /**
   * Insufficient Storage (507): The server is unable to store the representation needed to complete the request.
   */
  ...
  /**
   * Constructs a new DownloadStatusCode instance with the specified HTTP response code.
   *
  ...
  /**
   * Gets the DownloadStatusCode instance associated with the given HTTP response code.
   *
   * @param responseCode The HTTP response code.
  ...
  /**
   * Checks if the HTTP response code indicates a successful operation (2xx range).
   *
