...
public class DownloadStats implements DownloadStatsMXBean {
	...
	public void update(int threadId, long startRange, long endRange, long bytes, long transferred, long fileSzAtStart, long start,
			long end) {
		mThreadId = threadId;
	...
	public void add(int threadId, long startRange, long endRange, long bytes, long transferred, long fileSzAtStart, long start,
			long end) {
		mTransferred+=bytes;
	}
}
